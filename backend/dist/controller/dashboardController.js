...
exports.getDashboardCounts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var totalReviews, totalInquiries, totalBlog, totalEvent;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          totalInquiries = _context.sent;
          _context.next = 9;
          return BlogModel.countDocuments();
        case 9:
          totalBlog = _context.sent;
          _context.next = 12;
        ...
        case 16:
          ...
          console.error("Error fetching dashboard counts:", _context.t0);
          res.status(500).json({
            success: false,
