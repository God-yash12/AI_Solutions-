...
var Events = require("../model/eventModel");
var path = require("path");
var removeFile = require("../middleware/removeImage");
var _require = require("process"),
  constrainedMemory = _require.constrainedMemory;
var mongoose = require("mongoose");
var getImageUrl = require("../utils/getImageUrl");
var createEvent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, title, date, location, eventDetails, validMimeTypes, invalidFiles, imagePath, newEvent;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // Extract event details from the request body
          _req$body = req.body, title = _req$body.title, date = _req$body.date, location = _req$body.location, eventDetails = _req$body.eventDetails; // Validate input data
        ...
        case 6:
          ...
          invalidFiles = req.files.filter(function (file) {
        ...
        case 10:
          ...
          imagePath = req.files.map(function (file) {
        ...
        case 17:
          ...
          console.error("Error creating event:", _context.t0.message);
          res.status(500).json({
...
var getEventByCategory = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var currentTimeLocal, previousEvent, upcomingEvent;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          // Get the current local time
          currentTimeLocal = new Date(); // Fetch previous events (events that have already occurred)
          _context2.next = 4;
          return Events.find({
            date: {
              $lt: currentTimeLocal
        ...
        case 4:
          previousEvent = _context2.sent;
          _context2.next = 7;
          return Events.find({
            date: {
              $gte: currentTimeLocal
            }
          });
        case 7:
          upcomingEvent = _context2.sent;
...
var getEventById = /*#__PURE__*/function () {
  ...
  return function getEventById(_x5, _x6) {
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          id = req.params.id; // Check if the ID is provided and is a valid ObjectId
...
var updateEvent = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, _req$body2, title, date, eventDetails, images, existEvent, updatedEvent;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          id = req.params.id;
          _req$body2 = req.body, title = _req$body2.title, date = _req$body2.date, eventDetails = _req$body2.eventDetails, images = _req$body2.images; // Find the existing event by ID
          _context5.next = 5;
          return Events.findById(id);
        case 5:
          existEvent = _context5.sent;
          if (existEvent) {
            _context5.next = 8;
            break;
          }
        ...
        case 8:
          ...
          if (images && Array.isArray(images)) {
            ...
            if (existEvent.images && existEvent.images.length > 0) {
              existEvent.images.forEach(function (oldImage) {
                removeFile(oldImage);
              });
            }
  ...
  return function updateEvent(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var totalEvents = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          _totalEvents = _context6.sent;
          res.status(200).json({
            message: "Total event has been retrieved",
            data: _totalEvents
          });
          _context6.next = 11;
          break;
        case 7:
          ...
          res.status(500).json({
            message: "Failed to retrieve event count"
          });
        case 11:
        case "end":
  ...
  return function totalEvents(_x11, _x12) {
