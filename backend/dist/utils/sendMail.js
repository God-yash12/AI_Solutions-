...
var sendResponse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(recipientEmail, subject, responseMessage) {
    var emailOptions, info;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          emailOptions = {
            ...
            html: "<p>".concat(responseMessage, "</p>"),
            attachments: [{
              filename: "Logo.png",
  ...
  return function sendResponse(_x, _x2, _x3) {
